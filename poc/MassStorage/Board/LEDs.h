...
/* Enable C linkage for C++ Compilers: */
	...
	/* Public Interface - May be used in end-application: */
		/* Macros: */
			...
			#define LEDS_LED1        (1 << 0) // TODO: Add mask for first board LED here

			/** LED mask for the second LED on the board. */
			#define LEDS_LED2        (1 << 2) // TODO: Add mask for second board LED here

			/** LED mask for the third LED on the board. */
			#define LEDS_LED3        (1 << 4) // TODO: Add mask for third board LED here

			/** LED mask for the fourth LED on the board. */
			#define LEDS_LED4        (1 << 6) // TODO: Add mask for fourth board LED here
